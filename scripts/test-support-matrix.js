...
ok(enabled.has("over_under_2way"), "over_under compare enabled");
ok(enabled.has("asian_handicap_2way"), "asian handicap compare enabled");
ok(enabled.has("draw_no_bet_2way"), "draw_no_bet compare enabled");
ok(enabled.has("both_teams_to_score"), "BTTS compare enabled");
